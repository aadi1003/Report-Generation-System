...
export const SiteSelection = ({ sites, selectedSite, onSelect }: SiteSelectionProps) => {
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-1 sm:mb-2">Select Site</h2>
          <p className="text-sm text-muted-foreground">Choose the site for this report</p>
        </div>
      </div>
